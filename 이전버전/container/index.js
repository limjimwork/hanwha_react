        ...
        return(
            <div>
                <article id="container" className="clearfix">
                            ...
                            <section className="floor product_box product_top">
                                <a href="#" className="clearfix">
                                    <div className="linetop">
                                        ...
                                        <span>바닥재</span>
                                        <p>내추럴한 자연공간을<br />연출하는<br />아름다운 패턴의<br />바닥재입니다.</p>
                                    </div>
                                    <div className="img"><img src="/images/main/con_01on.jpg" alt="바닥재" /></div>
                            ...
                            <section className="stone product_box product_top">
                                <a href="#" className="clearfix">
                                    <div className="linetop">
                                        <h3>Well&#45;being</h3>
                                        <span>인테리어스톤</span>
                                        <p>자연소재에<br />첨단기술을 더한<br />친환경 인테리어<br />마감재입니다.</p>
                                    </div>
                                    <div className="img"><img src="/images/main/con_02on.jpg" alt="인테리어스톤" /></div>
                            ...
                            <section className="wallpaper product_box product_bot">
                                <a href="#" className="clearfix">
                                    <div className="linebot">
                                        ...
                                        <span>벽지</span>
                                        <p>편안함과 아름다움을<br />추구하는<br />신개념 감성벽지입니다.</p>
                                    </div>
                                    <div className="img"><img src="/images/main/con_03on.jpg" alt="벽지" /></div>
                            ...
                            <section className="windows product_box product_bot">
                                <a href="#" className="clearfix">
                                    <div className="linebot">
                                        ...
                                        <span>창호재</span>
                                        <p>과학적 시스템으로<br />에너지를 지켜주는<br />기술의 창호입니다.</p>
                                    </div>
                                    <div className="img"><img src="/images/main/con_04on.jpg" alt="창호재" /></div>
                    ...
                    <div className={"bg_popup" + (this.state.showVideo ? " on" : "")} onClick={()=>{this.setState({showVideo:false})}}>
                    ...
                    <div className="board">
                        <div className="center clearfix">
                            <section className="clip board_box" onClick={()=>{this.setState({showVideo:true})}}>
                            ...
                            <section className="co_info board_box clearfix">
                                ...
                                <div className="contribution">
                                    <h3>사회공헌</h3>
                                    <p>마음과 마음을 모아<br />따스한 사랑의 손길을 전하는<br />한화L&amp;C의 활동을<br />전달합니다.</p>
                                    <a href="#">바로가기</a>
                                </div>
                            </section>
                            ...
                            <section className="service board_box">
                                <div className="onshop">
                                    <h3><img src="/images/main/ico_onshop.png" alt="cart" /></h3>
                                    <p>Online Shop</p>
                                    <p>네이버 스토어팜<br />온라인 쇼핑몰입니다.</p><a href="#">SHOP</a>
                                </div>
                                <div className="gallery">
                                    <h3><img src="/images/main/ico_gallery.png" alt="gallery" /></h3>
                                    <p>Gallery Q</p>
                                    <p>한화L&amp;C의 토털 인테리어<br />솔루션 전시장입니다.</p><a href="#">GALLERY</a>
                                </div>
                            </section>
                        </div>
                    </div>
